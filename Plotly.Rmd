...
Shows relationship between average maximum temperature and precipitation for each station.
```{r echo=FALSE}
plot_ly(
...
Shows monthly distribution of maximum and minimum temperatures.
```{r echo=FALSE}
...
Shows annual snowfall trends.
```{r echo=FALSE}
# Bar plot of average annual snowfall
nynoaadat_cleaned %>%
  group_by(year) %>%
  summarize(
